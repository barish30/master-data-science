...
df_temp<-data_scrap[grep("Arroyomol" , data_scrap$level5),]
...
sapply(data_scrap[,c("price","rooms","surface","bathrooms")],function(x){round(mean(x,na.rm=TRUE),2)})
